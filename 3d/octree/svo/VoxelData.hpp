...
//    PlyLoader *_loader;
    ...
    int _dataW; // Total data width
    int _dataH; // Total data height
    int _dataD; // Total data depth

    int _virtualDataW; // Virtual data width (total data rounded to power of 2)
    int _virtualDataH; // Virtual data height (total data rounded to power of 2)
    int _virtualDataD; // Virtual data depth (total data rounded to power of 2)

    int _highestVirtualBit; // Highest voxel bit, in a 4x3x3 box it would be 3
    int _lowLutLevels;
